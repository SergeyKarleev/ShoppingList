...
public class MyDBManager implements BaseColumns {
	...
	String[] Prod_names = {
			...
			"Мороженое",			"Молоко",			"Творог",			"Кефир",			"Йогурт","Масло",	"Маргарин",		"Сыр","Сметана",			
			...
			"Головные уборы","Верхняя одежда","Нижнее белье","Официальная одежда","Обувь","Карнавальный костюм",			
